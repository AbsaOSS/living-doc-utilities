...
- Domain-specific high-risk areas
  - GitHub API usage: rate limits, retries/backoff behavior, and error handling.
  - GitHub Actions I/O: INPUT_* env var parsing and GITHUB_OUTPUT file writes.
  - Secrets handling: avoid leaking tokens/headers in logs.
  - Serialization contracts: JSON keys/structure in living_doc_utilities/model.
- Required tests
