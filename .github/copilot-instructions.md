...
String formatting
- Prefer f-strings for non-logging templates.
...
Repo additions
- Project name: living-doc-utilities
- Core package: living_doc_utilities/
- GitHub Actions I/O boundaries
  - Inputs: INPUT_* environment variables (see living_doc_utilities/github/utils.py)
  - Outputs: GITHUB_OUTPUT file format (name=value per line)
- Logging wiring: living_doc_utilities/logging_config.py
- Contract-sensitive outputs
  - Action output line format written by set_action_output
  - Input-name normalization (hyphen to underscore) in get_action_input
  - JSON serialization keys/structure from living_doc_utilities/model and living_doc_utilities/model/issues.py
- Commands
  - python3 -m venv .venv
